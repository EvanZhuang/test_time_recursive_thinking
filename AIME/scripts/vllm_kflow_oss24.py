...
""" 
    ...
    cmd_prompt = \
"""\n\nLet's solve this problem. First please criticize the reference solution. Examine them carefully and see if there is any reasoning gaps, calculation mistakes. Then try a new solution from scratch, using your analysis of the reference solution and the Wrong Answer List to guide your thinking.
        ...
        for example_ctr, example in enumerate(dataset):
            ...
            if reflex_ctr == 0:
                ...
                if len(summaries[example_ctr]) > 0:
                    summary_text = "For your reference, this is a solution to solve the problem, try to criticize it:{}".format(summaries[example_ctr][-1])
